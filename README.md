...
Testing alphabetize operation with input 'programming programming' ... Failed: expected:<[Answer: Chicken or Egg.]> but was:<[Enter an operation:]>
Finished: test_alphabetize_equal
Running: sub_op_case_sensitivity
Testing Calculator with operation sUbTraCT
Failed: You have too few lines of output! Expected 3 lines but was actually 2 lines.
...
Testing alphabetize operation with input 'Zebra zebra' ... Failed: expected:<[Answer: Chicken or Egg.]> but was:<[Enter an operation:]>
Finished: test_alphabetize_case
Running: test_alphabetize_less
Testing alphabetize operation with input 'Chicken Egg' ... Failed: expected:<[Answer: Chicken comes before Egg alphabetically.]> but was:<[Enter an operation:]>
...
Failed: You have the wrong number of lines of output! Expected 4 lines but was actually 2 lines.
Make sure to follow the output shown on the assignment description EXACTLY.
...
Failed: When prompting for words to alphabetize, Calculator does not print exactly:
"Enter two words:"
...
Failed: Your Calculator did not properly handle a divide by zero. Please check the homework assignment description
Expected: 'Invalid input entered. Terminating...'
...
Failed: Tested subtract opertation with input 1 2 and program incorrectly output:
List of operations: add, subtract, multiply, divide, and alphabetize.
Enter an operation:
Was looking for int value: -1
...
Failed: Valid switch statement not present
...
Testing alphabetize operation with input 'Egg Chicken' ... Failed: expected:<[Answer: Chicken comes before Egg alphabetically.]> but was:<[Enter an operation:]>
Finished: test_alphabetize_greater
Running: multiply_output_value
Failed: We tried 5.2222 1.1 as input, but you answered:
List of operations: add, subtract, multiply, divide, and alphabetize.
Enter an operation:
Finished: multiply_output_value
Running: subtract_prompt
Failed: Too few lines of output! Expected at least 3.
...
Failed: Your Calculator could not handle an invalid operation input: 'modulus'
Expected your output to contain:
Invalid input entered. Terminating...
But it could not be found. Please check the homework assignment description example.
...
Failed: Valid if/else statement not present
...
Failed: Your Calculator prompt is formatted incorrectly.Please check the homework assignment description expected:<...t of operations: add[ subtract multiply divide alphabetize]> but was:<...t of operations: add[, subtract, multiply, divide, and alphabetize.]>
...
Failed: Tested subtract opertation with input 1 3 and program incorrectly output:
List of operations: add, subtract, multiply, divide, and alphabetize.
Enter an operation:
Was looking for value (int or float okay): -2
Finished: subtract_output_value
Running: divide_output_value
Failed: We tried 3.14 2.7 as input, but you answered:
List of operations: add, subtract, multiply, divide, and alphabetize.
Enter an operation:
...
Test run: 35, Passed: 1, Failed: 34
Score: 2/100
